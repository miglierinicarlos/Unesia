...
struct ServerConfig
{
    ...
    static constexpr uint32_t DEFAULT_HPC_TIMEOUT = 30;
    static constexpr const char* DEFAULT_HPC_NODE_ID = "hpc-engine-0";
    ...
    uint32_t m_hpcTimeoutSecs;        ///< EOP_HPC_TIMEOUT      (1–300,    default 10)
    std::string m_hpcNodeId;          ///< HPC_NODE_ID                     (default "hpc-engine")
